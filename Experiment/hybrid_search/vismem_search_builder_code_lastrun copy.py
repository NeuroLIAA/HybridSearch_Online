...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/labuser/Documents/vismem_search_builder_code_lastrun.py',
...
win = visual.Window(
    ...
    monitor='C04_monitor', color=[1,1,1], colorSpace='rgb',
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('../Desktop/Psychopy_codes/Psychopy_vismemsearch/Psychopy_Exp_Params (2).xlsx'),
