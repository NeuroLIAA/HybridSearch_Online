...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/mji3/Dropbox/projects/hybrid_search_pavlovia/hybrid_search_july2020/vismem_search_builder_pavlovia2_lastrun.py',
...
Press x to finish the experiment' % (Perfo, random_ID)
...
# keep track of which components have finished
thanksComponents = [text, key_resp_end]
...
while continueRoutine:
    ...
    if key_resp_end.status == STARTED and not waitOnFlip:
        theseKeys = key_resp_end.getKeys(keyList=['x'], waitRelease=False)
