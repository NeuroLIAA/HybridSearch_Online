...
function embedded_formRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of embedded_formComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function random_seedRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of random_seedComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function CDT_Instr_trainRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of CDT_Instr_trainComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function CDT_trials_trainLoopBegin(thisScheduler) {
  ...
  for (const thisCDT_trials_train of CDT_trials_train) {
...
function CDT_trialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisCDT_trial of CDT_trials) {
...
function GNGtrials_trainLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisGNGtrials_train of GNGtrials_train) {
...
function GNG_trials_1LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisGNG_trial_1 of GNG_trials_1) {
...
function GNG_trials_2LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisGNG_trial_2 of GNG_trials_2) {
...
function GNG_trials_3LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisGNG_trial_3 of GNG_trials_3) {
...
function engprof_trialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisEngprof_trial of engprof_trials) {
...
function IUS12_trialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisIUS12_trial of IUS12_trials) {
...
function CDT_Trial_trainRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of CDT_Trial_trainComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function CDT_InstrRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of CDT_InstrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function CDT_TrialRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of CDT_TrialComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function GNG_Instr_TrainRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of GNG_Instr_TrainComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function GNG_fixRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of GNG_fixComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function GNG_Trial_TrainRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of GNG_Trial_TrainComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function GNG_FeedbackRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of GNG_FeedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function GNG_InstrRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of GNG_InstrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function GNG_trialRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of GNG_trialComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function GNG_Instr_2RoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of GNG_Instr_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function englishq_sliderRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of englishq_sliderComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function IUS12_InstrRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of IUS12_InstrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function trial_sliderRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of trial_sliderComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function thanks_2RoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of thanks_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
